...
class MarkersIndex {
    ...
    _onDocumentChange(change) {
        ...
        // Only update markers on editing text
        // markersHelper will fix the manipulations needed on create
        if (!isEmpty(change.created)) {
            return
        }
    ...
    _transformInsert(doc, markers, op) {
        ...
        markers.forEach(function(marker) {
            ...
            // This will extend the marker if the cursor is at the end of the marker and autoExpandRight is true.
            if (pos === end && marker.constructor.autoExpandRight) {
                marker.end.offset = newEnd + length
            }
