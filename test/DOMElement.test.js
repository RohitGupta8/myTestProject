...
function DOMElementTests() {

    const test = module('DOMElement')
    ...
    test("Parsing a full HTML document", function(t) {
        ...
        t.not(head, null, '<head> should be there')

        var title = head.find('title')
        t.not(title, null, '<head> should contain <title>')
        t.equal(title.text(), 'TEST', '.. with correct text')

        var body = doc.find('body')
        t.not(body, null, 'document should have a <body> element.')
    ...
    test("Parsing one HTML element", function(t) {
        ...
        t.not(p, null, 'HTML should get parsed.')
    ...
    test("Parsing multiple HTML elements", function(t) {
        ...
        t.not(els, null, 'HTML should get parsed.')
    ...
    test("Parsing an XML document", function(t) {
        ...
        t.not(head, null, '<myhead> should be there')
    ...
    test("setTagName", function(t) {
        ...
        t.not(el.find('b'), null, '.. including the <b> element')
        el.click()
    ...
    test("setTagName on XML should create XML elements", function(t) {
        ...
        // and all the content and attributes be copied over
        el.setTagName('foo')
        t.equal(el.getNativeElement().ownerDocument.contentType, 'text/xml', 'Element should still be an XML element')
    ...
    test("find via tagname", function(t) {
        ...
        let foo = el.find('foo')
        t.not(foo, null, 'Should find a <foo> element')
        t.end()
    })
    ...
    test("find via attr", function(t) {
        ...
        t.not(foo, null, 'Should find a element with data-id=foo')
        t.end()
    })
    ...
    test("find in XML with camelCase tagnames", function(t) {
        ...
        t.not(el.find('myNode'), null, 'Should find a <myNode> element')
        t.not(el.find('[myValue="foo"]'), null, 'Should find a [myValue] element')
        t.end()
    })
